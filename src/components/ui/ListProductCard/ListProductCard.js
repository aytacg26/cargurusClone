...
import classes from './ListProductCard.module.scss';

//when we fetch cars from database, we will fetch according to body style for products page,
//at backend, we will need to include dealer of each car to the car details.
const carDetails = {
  id: '001-897-00123',
...
const ListProductCard = () => {
  return (
    <div className={classes.ListProductCard}>
      <div className={classes.ImageSection}>
        <img
          src={carDetails.images[0].image}
